<!--
  ...
  Source: skills/accessibility-rules/SKILL.md
...
> **When this applies.** Use when creating or modifying anything a person will
> see, hear, or operate - a UI, web page, component, prototype, email, or
> dashboard - or when producing any HTML, CSS, JS, React, or template output,
> even a small snippet and even when the request never mentions accessibility.
