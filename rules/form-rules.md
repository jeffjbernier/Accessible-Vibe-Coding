<!--
  ...
  Source: skills/form-rules/SKILL.md
...
> **When this applies.** Use when creating or modifying any HTML form, form
> field, form partial, or form template, on the admin or public side of any
> app or site, or any page or partial that displays a single database record.
...
the read-only record display — live in [references/markup.md](https://github.com/jeffbernier/accessible-vibe-coding/blob/main/skills/form-rules/references/markup.md). Read that file
...
**Checking the mechanical half.** The accessible-vibe-coding repo ships [form-check.js](https://github.com/jeffbernier/accessible-vibe-coding/blob/main/skills/form-rules/scripts/form-check.js),
...
- **Prefer `aria-labelledby` pointing at a visible heading.** When the form
  ...
  "Form grid" in [references/markup.md](https://github.com/jeffbernier/accessible-vibe-coding/blob/main/skills/form-rules/references/markup.md).
